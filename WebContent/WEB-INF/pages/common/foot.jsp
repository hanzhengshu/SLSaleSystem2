<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
       ...
       <footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">love you zhengmeiting</a> 2018</p>
			<p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">hzs_hl</a></p>
		</footer>
